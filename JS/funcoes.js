...
//campo para limpar o estoque 
// function limparEstoque(produto, JSON) {
//         if (produtos === null)
//             alert=""
//         else {
//             produtos = 0;
...
// let transactions = [
//     { id: 1, name: 'Camera', amount: -20 },
//     { id: 2, name: 'Salário _ Funcionário', amount: 300 },
//     { id: 3, name: 'Compra de produtos ', amount: -10 },
//     { id: 4, name: 'Saidas de Produtos ', amount: 150 }
// ]
...
const updateBalanceValues = () => {
    ...
    const income = getIcome(transactionAmounts)
...
form.addEventListener('submit', event => {
    ...
    const transactionName = inputTranscationName.value.trim()
    const transactionAmount = inputTranscationAmount.value.trim()
    const isSomeInputEmpt = transactionName === '' || transactionAmount === ''

    if (isSomeInputEmpt) {
        alert('por favor, preencha tanto o nome quanto o Valor da transasão ')
        return
    }
